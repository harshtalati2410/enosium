      ...
      <div className="py-10 px-[10%] shadow-2xl grid grid-cols-12 gap-0.5 text-white">
        <div className="col-span-12 lg:col-start-1 lg:col-end-6 px-2 py-6">
          ...
          <p className="pt-10px text-[19px]">
            Stay tuned! In the future, our team plans to provide you with
            financial suggestions to improve your financials.
          </p>
        </div>
        ...
        <div className="col-span-full sm:col-span-6 lg:col-start-10 lg:col-end-13  px-2 py-6">
          ...
          <div className="grid grid-rows-4 gap-y-2 text-[18px]">
            <div className="row-span-1 grid grid-cols-6 gap-x-1 cursor-pointer hover:text-sky-300 duration-150">
              <div className="col-span-1">
                <i className="fa-solid fa-phone"></i>
              </div>
              <div className="col-start-2 col-end-7" href="tel:+91 7284842410">
                +91 7284842410
              </div>
            </div>
            <div
              className="row-span-1 grid grid-cols-6 gap-x-1 cursor-pointer hover:text-sky-300 duration-150"
              onClick={() =>
                (window.location.href = "mailto:harsht241003@gmail.com")
              }
            >
              <div className="col-span-1">
              ...
              <div className="col-start-2 col-end-7">
                harsht241003@gmail.com
              </div>
            </div>
          </div>
        </div>
      </div>
      <div className="hidden sm:block w-full bg-[#010649] text-white text-[30px] py-3 text-center">
